# run.py
"""
Single-file Streamlit chatbot for the Restaurant RAG app.

Expectations:
- vector_store_pinecone.py is in the same directory (the Pinecone wrapper) - optional.
- .env contains GEMINI_API_KEY and optionally PINECONE_API_KEY, PINECONE_CLOUD, PINECONE_REGION.
- Upload your taj-amer-food-menu.pdf via the sidebar (or drop it into working dir).
"""
...
class GeminiRAGService:
    ...
    def analyze_sentiment(self, text: str) -> Dict:
        """
        Ask the model to analyze sentiment and return JSON.
        """
        try:
            prompt = f"""Analyze this customer feedback and return a JSON object with the following keys:
...
Return only valid JSON:"""
            ...
            _log(f"[Gemini] sentiment analysis error: {e}")
            return {
                "error": str(e),
                "sentiment": "neutral",
                "confidence": 0.5,
